/*
 ============================================================================
 Name        : PreAssign_IACSD_Feb20_Q_18.c
...
void addConNum(){
	...
	while (trav->nextPtr != NULL) {
		int addValue = getAddition(i);
		addNodeAtGivenPos(addValue, i);
		i = i + 3;
		trav = getNodeAtGivenPos(i - 1);
...
int getAddition(int pos){
	NODE *node1,*node2;
	node1 = getNodeAtGivenPos(pos);
	pos++;
	node2 = getNodeAtGivenPos(pos);
	int addValue = (node1->data + node2->data);
	return addValue;
}
